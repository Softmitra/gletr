...
@section('title', 'Business Setup - General Settings')

@section('page_title', 'Business Setup - General Settings')
...
<style>
    ...
    /* Enhanced Maintenance Toggle for Page Content */
    #page-content .maintenance-toggle {
        display: flex;
        align-items: center;
        justify-content: space-between;
        background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%);
    ...
    #page-content .maintenance-info h5 {
        margin: 0 0 0.5rem 0;
        color: #92400e;
        font-weight: 700;
        font-size: 1.1rem;
    ...
    #page-content .maintenance-info p {
        margin: 0;
        color: #a16207;
        font-size: 0.9rem;
        line-height: 1.5;
    ...
    /* Enhanced Modern Switch for Page Content */
    #page-content .modern-switch {
        position: relative;
        display: inline-block;
        width: 64px;
        height: 36px;
    ...
    #page-content .modern-switch input {
        opacity: 0;
        width: 0;
        height: 0;
    }
    ...
    #page-content input:checked + .switch-slider {
        background: var(--primary-color);
        box-shadow: inset 0 2px 4px rgba(99, 102, 241, 0.2);
    }

    #page-content input:checked + .switch-slider:before {
        transform: translateX(28px);
        box-shadow: var(--shadow-lg);
    }
</style>
        ...
        <div class="col-12">
            ...
            <div class="business-setup-nav">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.business.setup.general') }}">
            ...
            <div id="page-content">
                @include('admin.business.setup.tabs.general', ['activeTab' => 'general'])
            </div>
        </div>
    </div>
</div>
...
function initGeneralPage() {
    ...
    $('#maintenance-mode').on('change', function() {
        ...
        if (isEnabled) {
            if (confirm('Are you sure you want to enable maintenance mode?')) {
                // Handle maintenance mode enable
    ...
    // Form submission
    $('form[data-form-type="general"]').on('submit', function(e) {
        e.preventDefault();
