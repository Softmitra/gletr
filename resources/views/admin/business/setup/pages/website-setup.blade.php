...
@section('title', 'Business Setup - Website Setup')

@section('page_title', 'Business Setup - Website Setup')
        ...
        <div class="col-12">
            ...
            <div class="business-setup-nav">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.business.setup.website-setup') }}">
            ...
            <div id="page-content">
                @include('admin.business.setup.tabs.website-setup', ['activeTab' => 'website-setup'])
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    initWebsiteSetupPage();
});

function initWebsiteSetupPage() {
    // Form submission
    $('form[data-form-type="website-setup"]').on('submit', function(e) {
        e.preventDefault();
